  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: IconThemeData(color: Colors.black),
        elevation: 0.0,
        title: Text('Legal इनोवेटर्स Details',style: TextStyle(color: Colors.black),),
        shape: Border(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: 'Your Present Court Name'
                    ),
                    validator: (value){
                      if(value!.isEmpty){
                        return 'Please complete required field';
