List<List<String>> sweetSayings = [
  ["Legal इनोवेटर्स", "reshape the future"],
  ["Legal excellence", "requires a commitment"],
  ["Your Law ", "your responsibility"],
  ["Legal pioneers", "are the architects"]
];

List<String> articleTitle = [
  "Innovation in Legal Practice",
  "Legal Pioneers of Tomorrow",
  "Innovating Law for Justice",
  "Leading Legal Innovation Today"
];
List<String> imageSliders = [
  "https://img.freepik.com/premium-vector/law-justice-concept-scales-justice-building-judge-hammer-judge-supreme-court-cartoon-flat-style_313437-88.jpg",
  "https://static.vecteezy.com/system/resources/previews/016/006/572/original/law-firm-services-with-justice-legal-advice-judgement-and-lawyer-consultant-in-flat-cartoon-poster-hand-drawn-templates-illustration-vector.jpg",
  "https://t3.ftcdn.net/jpg/02/28/86/46/360_F_228864674_5MqgoflYi2Ty705PeQZOSQPXJMZYMPRI.jpg",
  "https://c8.alamy.com/comp/2PWJDAE/law-firm-services-with-justice-legal-advice-judgement-and-lawyer-consultant-in-flat-cartoon-poster-hand-drawn-templates-illustration-2PWJDAE.jpg",
];
